...
public class King extends Piece {
	...
	// Pre: b is a non-null board that contains some squares. The
	// currentSquare is non-null and present in the board.
	// Post: Returns all legally accessable squares by this piece. In the event that no squares are accessable returns an empty list.
	@Override
